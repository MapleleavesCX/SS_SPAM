...
_output_file_path = os.path.join(ROOT_DIR, 'data', 'NewSpamData.csv')
...
# # 保存处理后的数据到CSV文件
# print("保存中...")
# preprocessor.save_to_csv(output_file_path=_output_file_path)
# print("over!")
...
# print("读取处理后的数据...")
# # 这里需要根据个人存放数据集的路径去更改
# newdata = pd.read_csv(_output_file_path)
